...
|--------|------------|------------------|-------------|---------------|--------|
| NVIDIA | Ada Lovelace | RTX 4090 | Proprietary 570 | CUDA 12.x | Supported |
| NVIDIA | Ampere | RTX 3060 | Proprietary 570 | CUDA 12.x | Supported |
| NVIDIA | Pascal | GTX 1080 | Proprietary 570 | CUDA 12.x | Supported |
