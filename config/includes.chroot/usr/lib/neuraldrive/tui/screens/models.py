...
CURATED_MODELS = [
    (
        "CPU / ≤4 GB VRAM",
        [
            ("gemma3:4b",         "3.3 GB", "Google multimodal, 128K context"),
            ("qwen2.5:3b",        "1.9 GB", "Fast general-purpose"),
            ("phi4-mini:3.8b",    "2.5 GB", "Microsoft compact reasoning"),
            ("nomic-embed-text",  "274 MB", "Standard RAG embedding model"),
        ],
    ),
    (
        "6 GB VRAM",
        [
            ("llama3.1:8b",          "4.7 GB", "Meta default starter, general-purpose"),
            ("qwen2.5-coder:7b",     "4.7 GB", "Top coding model in 7B class"),
            ("deepseek-r1:8b",       "5.2 GB", "Distilled chain-of-thought reasoning"),
            ("llama3.2:3b",          "2.0 GB", "Meta ultra-compact"),
        ],
    ),
    (
        "8-12 GB VRAM",
    ...
    (
        "16-24 GB VRAM",
        [
            ("qwen2.5-coder:32b",     "20 GB", "Top open-source coding (92.7% HumanEval)"),
            ("qwen3-coder:30b",       "19 GB", "Agentic coding (MoE, 256K context)"),
            ("deepseek-r1:32b",       "20 GB", "Top reasoning (72.6% LiveCodeBench)"),
            ("codestral:22b",         "13 GB", "Mistral code model (FIM-optimized)"),
            ("mistral-small3.2:24b",  "14 GB", "Multilingual specialist"),
            ("qwen2.5:32b",           "20 GB", "Strong general-purpose multilingual"),
        ],
    ),
    (
        "40 GB+ VRAM",
